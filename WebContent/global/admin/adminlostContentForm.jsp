...
<%
   ...
   try{
	   ...
	   adminlostDTO article =  dbPro.getArticle1(num);
  ...
  <tr height="30">      
    ...
    <%
	  ...
	  <input type="button" value="글수정" 
       onclick="document.location.href='adminlostupdateForm.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">
	   &nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="button" value="글삭제" 
       onclick="document.location.href='adminlostdeleteForm.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">
	   &nbsp;&nbsp;&nbsp;&nbsp;
	   <%}%> 

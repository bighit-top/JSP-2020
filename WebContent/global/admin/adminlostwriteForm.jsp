...
<form method="post" name="adminlostwriteform" action="adminlostwritePro.jsp" onsubmit="return writeSave()">
...
<tr>      
 <td colspan=2  align="center"> 
  ...
  <input type="button" value="목록보기" OnClick="window.location='adminLostForm.jsp'">
</td></tr></table>    
